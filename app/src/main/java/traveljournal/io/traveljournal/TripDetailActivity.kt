...
/**
 * An activity representing a single Trip detail screen. This
 * activity is only used on narrow width devices. On tablet-size devices,
 * item details are presented side-by-side with a list of items
 * in a [TripListActivity].
 */
        ...
        if (savedInstanceState == null) {
            ...
            val fragment = TripDetailFragment().apply {
                arguments = Bundle().apply {
                    putString(TripDetailFragment.ARG_ITEM_ID,
    ...
    override fun onOptionsItemSelected(item: MenuItem) =
            when (item.itemId) {
                android.R.id.home -> {
                    ...
                    navigateUpTo(Intent(this, TripListActivity::class.java))
                    true
                }
